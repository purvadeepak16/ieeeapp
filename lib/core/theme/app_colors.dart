...
class AppColors {
  ...
  static const Color neoShadow =
      Color(0xCC111111); // Professional 80% opacity black
  static const Color neoShadowDark = Color(0x8A000000);

  // Profile/neo interaction alphas
  static const double neoHoverShadowAlphaLight = 0.22;
  static const double neoHoverShadowAlphaDark = 0.35;
  static const double profileAccentFillAlpha = 0.14;
